...
GizmoGo is a React + Vite earbuds storefront. It features a landing page for browsing different types of earbuds, a navbar search bar, reusable product cards, and API-backed product data.
